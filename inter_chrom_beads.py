...
# pb.set_tempdir('/sc/orga/projects/akbars02a/Sergio/programs/NCHG_hic/preprocess_scripts-master')
sys.path.insert(0, '/sc/orga/projects/akbars02a/Sergio/programs')
